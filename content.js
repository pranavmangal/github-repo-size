...
function listRepoSize(value, unit) {
  ...
  anchor.innerHTML = fileZipSVG({ forSidebar: false });
...
function addToDetailsList(value, unit) {
  ...
  if (lastElem) {
    ...
    lastElem.parentNode.insertBefore(sizeElem, lastElem);
  }
}
...
function sidebarRepoSize(value, unit) {
  ...
  anchor.innerHTML = fileZipSVG({ forSidebar: true });
  anchor.appendChild(valueElem);
